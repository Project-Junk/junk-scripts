...
sleep 1s
sudo pacman -S git jq clash feh yay dunst i3-gaps automake make autoconf dbus-python i3blocks mpd ncmpcpp neovim rofi i3lock gnome-screenshot alacritty ttf-font-awesome playerctl
sleep 1s
